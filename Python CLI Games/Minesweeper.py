...
def exit_handler()-> None :
    print(blank); print("Thanks for playing, hope we will meet soon."); sleep(3); print(blank); exit()
def grid_blueprint() -> None :
    global grid_size
    while 1==1:
        print(blank)
        print("Set your level of difficulty."); sleep(1)
        print("Easy    : 10*10 [1]")
        ...
        while (True):
            print(blank)
            print("Your are choosing {} grid, continue?".format("Easy (10*10)" if level==1 else "Medium (18*15)" if level==2 else "Hard (25*20)" if level==3 else "Extreme (40*20)" if level==4 else "Custom (Value selection ahead)"))
            confirmation = input("[Y/N] : ")
            if confirmation.lower().find('n')!=-1:
                print("Change the difficulty."); sleep(1); print(blank)
                con_val = True; break
    ...
    if level==1: value1 = 10; value2 = 10
        ...
        while 1==1:
            print(blank)
            print("Enter the size of the grid you want. (In next step)"); sleep(2)
            while 1==1:
                print(blank)
                value1 = input("Enter the number of rows (from 3 to 20) : ")
            ...
            while 1==1:
                print(blank)
                value2 = input("Enter the number of columns (from 3 to 15) : ")
            ...
            print(blank)
            print("The size of grid is {}*{}, correct?".format(value1, value2))
            confirmation = input("[Y/N] : ")
...
while (True):
    print(blank)
    print("Welcome To Classic Minesweeper."); sleep(2); print(blank)
    print("You have to flag the mines, but careful, one wrong step can take you blown away :)"); sleep(3)
    print("Get ready."); sleep(1); print(blank); grid_blueprint()
    while 1==1:
        print(blank)
        flagged_blocks_copy = flagged_blocks.copy(); mined_block_copy = mined_blocks.copy()
        print(main_grid % tuple(format_characters))
        error = digger(grid_size); print(blank)
